...
namespace Watson.Nodes.Api.Controllers
{
    ...
    public sealed class ItemsController : NodesControllerBase
    {
        private readonly NodeKind _kind = NodeKind.Item;
        public ItemsController(ILogger<ItemsController> logger, INodeService nodeService) : base(logger, nodeService)
        {
        }
