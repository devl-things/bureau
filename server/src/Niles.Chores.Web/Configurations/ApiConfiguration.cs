namespace Niles.Chores.Web.Configurations
{
    public class ApiConfiguration
    {
        ...
        public string PrioritizedChoresSegment { get; set; } = "/prioritized-chores";
        ...
        public string PrioritizedChoresEndpoint { get { return $"{HousekeepingEndpoint}{PrioritizedChoresSegment}"; } }
