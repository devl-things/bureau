...
namespace Sven.Controllers.Connect
{
    ...
    [EnableRateLimiting("authorize-endpoint")]
    public class AuthorizeController : ConnectController
    {
        private readonly IClientService _clientService;
        private readonly IAuthCodeService _authCodeManager;

        public AuthorizeController(ILogger<AuthorizeController> logger, IClientService clientService, IAuthCodeService authCodeManager) : base(logger)
        {
