...
using Bureau.UI.API.V3.Mappers;
...
namespace Bureau.UI.API.V3.Methods
{
    internal class RecipesMethods
    {
            ...
            [FromServices] LinkGenerator linkGenerator)
        {
            ...
            var url = linkGenerator.GetUriByAddress(
                httpContext,
                $"{BureauAPIRouteNames.GetRecipeById}-{httpContext.GetRequestedApiVersion()}", // Name of the route we want to link to
