...
namespace Bureau.Data.Postgres.Migrations
{
    ...
    [Migration("20250123083032_OccurrenceRecord")]
    partial class OccurrenceRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bureau.Data.Postgres.Models.OccurrenceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Bureau.Data.Postgres.Models.OccurrenceRecord", b =>
                {
                    b.HasOne("Bureau.Data.Postgres.Models.Record", "Record")
                        .WithOne()
                        .HasForeignKey("Bureau.Data.Postgres.Models.OccurrenceRecord", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
